package com.poly.ps36680_vudangquang.rest.controller;

import com.poly.ps36680_vudangquang.entity.Employee;
import com.poly.ps36680_vudangquang.service.impl.StudentServiceImpl;
...
public class StudentRestController {
    ...
    @PostMapping
    public ResponseEntity<?> createStudent(@RequestBody Employee student) {
        Map<String, Object> res = new LinkedHashMap<>();
        try {
    ...
    @PutMapping
    public ResponseEntity<?> updateStudent(@RequestBody Employee student) {
        Map<String, Object> res = new LinkedHashMap<>();
        try {
            res.put("data", studentService.addStudent(student));
            res.put("success", true);
